import { GRID_SIZE, game } from "./game.js";
import { renderText, renderHighScores, saveHighScore } from "./functions.js";
  ...
  constructor() {
    ...
    this.checkCollision = function (other) {
      ...
      for (var i = 0; i < count; i++) {
        ...
        // Consider different implementations for checking point in polygon
        if (isPointInPolygon(this, px, py)) {
  ...
  constructor() {
    ...
    this.collision = function (other) {
      ...
      if (this.scale > 0.5) {
        ...
        for (var i = 0; i < 3; i++) {
          var roid = $.extend(true, {}, this); //no easy alternative to jQuery here, need to make a deep clone of class
